...
subtest 'parse schema from a file', {
    my LibXML::RelaxNG $rngschema = $xmlparser.create( LibXML::RelaxNG, location => $file );
...
subtest 'parse schema from a string', {
    ...
    my LibXML::RelaxNG $rngschema = $xmlparser.create( LibXML::RelaxNG, string => $string );
    ok $rngschema.defined;
...
subtest 'parse schema from a document', {
    ...
    my LibXML::RelaxNG $rngschema = $doc.create( LibXML::RelaxNG, :$doc );
    ok $rngschema.defined;
...
subtest 'validate a document', {
    ...
    my LibXML::RelaxNG $rngschema = $doc.create( LibXML::RelaxNG, location => $file );
...
subtest 're-validate a modified document', {
    my LibXML::RelaxNG $rng = $xmlparser.create(LibXML::RelaxNG, location => $demo4);
