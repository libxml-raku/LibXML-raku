...
class LibXML::Node does LibXML::Item {
    ...
    method nodeName is rw is also<name tagName tag> {
        Proxy.new(
    ...
    sub iterate-list($parent, $of, :$doc = $of.doc, Bool :$keep-blanks = True, Bool :$properties = False) is export(:iterate-list) {
        # follow a chain of .next links.
        (require ::('LibXML::Node::List')).new: :$of, :$doc, :$keep-blanks, :$parent, :$properties;
    }
