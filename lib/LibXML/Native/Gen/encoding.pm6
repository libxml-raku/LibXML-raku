...
struct xmlCharEncodingHandler is repr('CStruct') {
    ...
    method xmlRegisterCharEncodingHandler( --> void) is native(LIB) {*};
}
    sub UTF8Toisolat1(unsigned char * $out, int * $outlen, const unsigned char * $in, int * $inlen --> int32) is native(LIB) {*};
    sub isolat1ToUTF8(unsigned char * $out, int * $outlen, const unsigned char * $in, int * $inlen --> int32) is native(LIB) {*};
    ...
    sub xmlCleanupCharEncodingHandlers( --> void) is native(LIB) {*};
    sub xmlCleanupEncodingAliases( --> void) is native(LIB) {*};
    ...
    sub xmlInitCharEncodingHandlers( --> void) is native(LIB) {*};
