...
use LibXML::Native::Defs :LIB, :XmlCharP;
    ...
    sub docbEncodeEntities(unsigned char * $out, int * $outlen, const unsigned char * $in, int * $inlen, int32 $quoteChar --> int32) is native(LIB) {*};
    sub docbFreeParserCtxt(docbParserCtxt $ctxt --> void) is native(LIB) {*};
