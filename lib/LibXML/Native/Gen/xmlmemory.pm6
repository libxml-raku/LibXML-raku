...
use LibXML::Native::Defs :LIB, :XmlCharP;
    sub xmlCleanupMemory( --> void) is native(LIB) {*};
    ...
    sub xmlMemDisplay(FILE * $fp --> void) is native(LIB) {*};
    sub xmlMemDisplayLast(FILE * $fp, long $nbBytes --> void) is native(LIB) {*};
    sub xmlMemFree(Pointer $ptr --> void) is native(LIB) {*};
