...
use LibXML::Native::Defs :LIB, :XmlCharP;
    sub xmlXPathDebugDumpCompExpr(FILE * $output, xmlXPathCompExpr $comp, int32 $depth --> void) is native(LIB) {*};
    sub xmlXPathDebugDumpObject(FILE * $output, xmlXPathObject $cur, int32 $depth --> void) is native(LIB) {*};
