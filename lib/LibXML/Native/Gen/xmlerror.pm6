...
struct xmlError is repr('CStruct') {
    ...
    has xmlErrorLevel $.level; # how consequent is the error
    ...
    method xmlResetError( --> void) is native(LIB) {*};
}
    sub initGenericErrorDefaultFunc(xmlGenericErrorFunc * $handler --> void) is native(LIB) {*};
    sub xmlCtxtResetLastError(Pointer $ctx --> void) is native(LIB) {*};
    sub xmlParserError(Pointer $ctx, Str $msg, ... $... --> void) is native(LIB) {*};
    sub xmlParserValidityError(Pointer $ctx, Str $msg, ... $... --> void) is native(LIB) {*};
    sub xmlParserValidityWarning(Pointer $ctx, Str $msg, ... $... --> void) is native(LIB) {*};
    sub xmlParserWarning(Pointer $ctx, Str $msg, ... $... --> void) is native(LIB) {*};
    sub xmlResetLastError( --> void) is native(LIB) {*};
    sub xmlSetGenericErrorFunc(Pointer $ctx, xmlGenericErrorFunc $handler --> void) is native(LIB) {*};
    sub xmlSetStructuredErrorFunc(Pointer $ctx, xmlStructuredErrorFunc $handler --> void) is native(LIB) {*};
