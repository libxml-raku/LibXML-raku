...
struct xmlList is repr('CPointer') {
    ...
    method xmlListClear( --> void) is native(LIB) {*};
    method xmlListCopy(const xmlList $old --> int32) is native(LIB) {*};
    method xmlListDelete( --> void) is native(LIB) {*};
    ...
    method xmlListMerge(xmlList $l2 --> void) is native(LIB) {*};
    method xmlListPopBack( --> void) is native(LIB) {*};
    method xmlListPopFront( --> void) is native(LIB) {*};
    ...
    method xmlListReverse( --> void) is native(LIB) {*};
    method xmlListReverseSearch(Pointer $data --> Pointer) is native(LIB) {*};
    method xmlListReverseWalk(xmlListWalker $walker, Pointer $user --> void) is native(LIB) {*};
    method xmlListSearch(Pointer $data --> Pointer) is native(LIB) {*};
    method xmlListSize( --> int32) is native(LIB) {*};
    method xmlListSort( --> void) is native(LIB) {*};
    method xmlListWalk(xmlListWalker $walker, Pointer $user --> void) is native(LIB) {*};
}
