...
struct xmlSchemaFacet is repr('CStruct') {
    ...
    method xmlSchemaFreeFacet( --> void) is native(LIB) {*};
...
struct xmlSchemaType is repr('CStruct') {
    ...
    method xmlSchemaFreeType( --> void) is native(LIB) {*};
...
struct xmlSchemaVal is repr('CPointer') {
    ...
    method xmlSchemaFreeValue( --> void) is native(LIB) {*};
...
struct xmlSchemaWildcard is repr('CStruct') {
    ...
    has int32 $.flags;
    method xmlSchemaFreeWildcard( --> void) is native(LIB) {*};
}
