...
struct xmlHashTable is repr('CPointer') {
    ...
    method xmlHashFree(xmlHashDeallocator $f --> void) is native(LIB) {*};
    ...
    method xmlHashScan(xmlHashScanner $f, Pointer $data --> void) is native(LIB) {*};
    method xmlHashScan3(xmlCharP $name, xmlCharP $name2, xmlCharP $name3, xmlHashScanner $f, Pointer $data --> void) is native(LIB) {*};
    method xmlHashScanFull(xmlHashScannerFull $f, Pointer $data --> void) is native(LIB) {*};
    method xmlHashScanFull3(xmlCharP $name, xmlCharP $name2, xmlCharP $name3, xmlHashScannerFull $f, Pointer $data --> void) is native(LIB) {*};
    ...
    sub xmlHashDefaultDeallocator(Pointer $entry, xmlCharP $name --> void) is native(LIB) {*};
