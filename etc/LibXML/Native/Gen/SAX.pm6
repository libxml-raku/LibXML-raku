...
sub attributeDecl(Pointer $ctx, xmlCharP $elem, xmlCharP $fullname, int32 $type, int32 $def, xmlCharP $defaultValue, xmlEnumerationPtr $tree) is native(LIB) {*};
...
sub elementDecl(Pointer $ctx, xmlCharP $name, int32 $type, xmlElementContentPtr $content) is native(LIB) {*};
...
sub getEntity(Pointer $ctx, xmlCharP $name --> xmlEntityPtr) is native(LIB) {*};
sub getLineNumber(Pointer $ctx --> int32) is native(LIB) {*};
sub getNamespace(Pointer $ctx --> xmlNsPtr) is native(LIB) {*};
sub getParameterEntity(Pointer $ctx, xmlCharP $name --> xmlEntityPtr) is native(LIB) {*};
...
sub resolveEntity(Pointer $ctx, xmlCharP $publicId, xmlCharP $systemId --> xmlParserInputPtr) is native(LIB) {*};
sub setDocumentLocator(Pointer $ctx, xmlSAXLocatorPtr $loc) is native(LIB) {*};
